...
export async function POST(req: NextRequest) {
  return withApiHandler(async () => {
    ...
    logActivity({ workspaceId: body.workspaceId, userId: session.user.id, userName: session.user.name ?? 'User', action: 'created', resourceType: 'collection', resourceName: collection.name })
